...
val modifiedSmithsHouse: House = smithsHouse.copy(price = 390000)
val modifiedThacherHouse: House = thacherHouse.copy(price = 255000)
val modifiedShelbyHouse: House = shelbyHouse.copy(availability = "Let Agreed ")
